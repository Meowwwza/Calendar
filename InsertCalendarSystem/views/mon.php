                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <script>
                                ...
                                // สร้างแผนภูมิแท่ง
                                var backgroundColors = semesterParts.map(part => part === "1" ? 'rgba(54, 162, 235, 0.2)' : 'rgba(255, 99, 132, 0.2)');
                                var borderColors = semesterParts.map(part => part === "1" ? 'rgba(54, 162, 235, 1)' : 'rgba(255, 99, 132, 1)');
